...
import { Table, Tag, Space, Button, Input, Select, DatePicker, message, Tooltip } from 'antd';
...
export default memo(function ErrorReportList({}: ErrorReportListProps) {
  ...
  return (
    <div className="p-6 bg-white">
      ...
      {/* 详情模态框 */}
      <ErrorDetailModal visible={detailVisible} record={selectedRecord} onClose={handleCloseDetail} />
    </div>
  );
});
